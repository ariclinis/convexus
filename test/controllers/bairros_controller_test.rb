...
class BairrosControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create bairro" do
    assert_difference('Bairro.count') do
      post bairros_url, params: { bairro: { codigo: @bairro.codigo, descricao: @bairro.descricao, municipio_id: @bairro.municipio_id } }
    end
  ...
  test "should update bairro" do
    patch bairro_url(@bairro), params: { bairro: { codigo: @bairro.codigo, descricao: @bairro.descricao, municipio_id: @bairro.municipio_id } }
