...
class BancosControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create banco" do
    assert_difference('Banco.count') do
      post bancos_url, params: { banco: { CodBanco: @banco.CodBanco, descricao: @banco.descricao, estado: @banco.estado, utilizador: @banco.utilizador } }
    end
  ...
  test "should update banco" do
    patch banco_url(@banco), params: { banco: { CodBanco: @banco.CodBanco, descricao: @banco.descricao, estado: @banco.estado, utilizador: @banco.utilizador } }
