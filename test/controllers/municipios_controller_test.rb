...
class MunicipiosControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create municipio" do
    assert_difference('Municipio.count') do
      post municipios_url, params: { municipio: { codigo: @municipio.codigo, descricao: @municipio.descricao, provincia_id: @municipio.provincia_id } }
    end
  ...
  test "should update municipio" do
    patch municipio_url(@municipio), params: { municipio: { codigo: @municipio.codigo, descricao: @municipio.descricao, provincia_id: @municipio.provincia_id } }
