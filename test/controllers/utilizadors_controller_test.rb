...
class UtilizadorsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create utilizador" do
    assert_difference('Utilizador.count') do
      post utilizadors_url, params: { utilizador: { email: @utilizador.email, estado: @utilizador.estado, nivel_acesso: @utilizador.nivel_acesso, nome: @utilizador.nome, nome_login: @utilizador.nome_login, senha: @utilizador.senha } }
    end
  ...
  test "should update utilizador" do
    patch utilizador_url(@utilizador), params: { utilizador: { email: @utilizador.email, estado: @utilizador.estado, nivel_acesso: @utilizador.nivel_acesso, nome: @utilizador.nome, nome_login: @utilizador.nome_login, senha: @utilizador.senha } }
