...
class MoedasControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create moeda" do
    assert_difference('Moeda.count') do
      post moedas_url, params: { moeda: { codigo: @moeda.codigo, descricao: @moeda.descricao, pais: @moeda.pais } }
    end
  ...
  test "should update moeda" do
    patch moeda_url(@moeda), params: { moeda: { codigo: @moeda.codigo, descricao: @moeda.descricao, pais: @moeda.pais } }
