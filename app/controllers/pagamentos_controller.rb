class PagamentosController < ApplicationController
  ...
  # GET /pagamentos.json
  def index
    @pagamentos = Pagamento.all.order("created_at DESC").paginate(page: params[:page], per_page: 5)
  end
  ...
  private
    ...
    def pagamento_params
      params.require(:pagamento).permit(:codigo, :formaPagamento, :banco_id, :conta_bancaria_id, :numeroTalao, :dataPagamento, :valorTalao, :valorUtilizado)
    end
end
